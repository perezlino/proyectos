...
def obtener_random_user():                                                

    try:                                                                                 
        response = requests.get(f'https://microsoftedge.github.io/Demos/json-dummy-data/64KB.json')
