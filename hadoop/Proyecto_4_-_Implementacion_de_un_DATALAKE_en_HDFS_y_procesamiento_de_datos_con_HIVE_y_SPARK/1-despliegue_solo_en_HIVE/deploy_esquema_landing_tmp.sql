...
-- Subida de datos
LOAD DATA INPATH '/user/proyectos/proyecto_1/archivos/persona.data' INTO TABLE LANDING_TMP.PERSONA;
...
-- Subida de datos
LOAD DATA INPATH '/user/proyectos/proyecto_1/archivos/empresa.data' INTO TABLE LANDING_TMP.EMPRESA; 
...
-- Subida de datos
LOAD DATA INPATH '/user/proyectos/proyecto_1/archivos/transacciones.data' INTO TABLE LANDING_TMP.TRANSACCION;
