...
def perform_data_clean(df1,df2):
    ...
    #10 Impute TRX_CNT where it is null as avg of trx_cnt for that prescriber
        ...
        # a las agrupaciones de la columna "presc_id". Es decir, una ventana para todos los valores
        # iguales. Se utilizó la función "coalesce()" para rellenar este promedio donde existen
