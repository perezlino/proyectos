...
LOCATION '/user/${hiveconf:PARAM_RAIZ}/${hiveconf:PARAM_PROYECTO}/database/landing_tmp';
...
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/user/${hiveconf:PARAM_RAIZ}/${hiveconf:PARAM_PROYECTO}/database/landing_tmp/persona';
...
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/user/${hiveconf:PARAM_RAIZ}/${hiveconf:PARAM_PROYECTO}/database/landing_tmp/empresa';
...
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/user/${hiveconf:PARAM_RAIZ}/${hiveconf:PARAM_PROYECTO}/database/landing_tmp/transaccion';
...
-- Utilizar este comando para ejecutar script sql en mi estorno de Hadoop personal                                      
    ...
    |                                                                                                               |         
    |   beeline -u jdbc:hive2://localhost:10000 -f /home/main/proceso_1.sql --hiveconf "PARAM_USERNAME=XXXXX"       |
    |_______________________________________________________________________________________________________________|