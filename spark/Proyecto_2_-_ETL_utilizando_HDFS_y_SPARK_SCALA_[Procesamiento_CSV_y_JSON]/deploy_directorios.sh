...
##
## al directorio /hadoop-data/proyecto_3/archivos ubicado en el contenedor "namenode"
...
hdfs dfs -put \
/hadoop-data/proyecto_3/archivos/RIESGO_CREDITICIO.csv \
/hadoop-data/proyecto_3/archivos/transacciones_bancarias.json \
